...
// Connect-event drain benchmark for the per-client clusters collection: one
// client connecting re-runs every backend transform, each translating for every
// connected client, and each translation paying strict validation.
