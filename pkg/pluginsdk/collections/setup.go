...
func (c *CommonCollections) InitCollections(
	...
	tcpRouteWriteGVRs := selectRouteGVRs(
		discoverRouteVersions(c.Client.Ext(), wellknown.TCPRouteCRDName),
		tcpRouteGVRs,
	...
	for _, tcpRouteGVR := range tcpRouteWriteGVRs {
		...
		case gwv1.GroupVersion.Version:
			tcpRoutesV1 := krt.WrapClient(
				newDelayedTypedInformer(c.Client, tcpRouteGVR, func() kclient.Informer[*gwv1.TCPRoute] {
		...
		case gwv1a2.GroupVersion.Version:
			preV1TCPRoutes := krt.WrapClient(
				newDelayedTypedInformer(c.Client, tcpRouteGVR, func() kclient.Informer[*gwv1a2.TCPRoute] {
	...
	tlsRouteWriteGVRs := selectRouteGVRs(
		discoverRouteVersions(c.Client.Ext(), wellknown.TLSRouteCRDName),
		tlsRouteGVRs,
		globalSettings.EnableExperimentalGatewayAPIFeatures,
	)
	...
	for _, tlsRouteGVR := range tlsRouteWriteGVRs {
		...
		case gwv1.GroupVersion.Version:
			...
			tlsRoutesV1 := krt.WrapClient(
				newDelayedTypedInformer(c.Client, tlsRouteGVR, func() kclient.Informer[*gwv1.TLSRoute] {
		...
		case wellknown.TLSRouteV1Alpha3Version:
			preV1TLSRoutes := krt.WrapClient(
				newDelayedTypedInformer(c.Client, tlsRouteGVR, func() kclient.Informer[*gwv1a3.TLSRoute] {
		...
		case gwv1a2.GroupVersion.Version:
			preV1TLSRoutes := krt.WrapClient(
				newDelayedTypedInformer(c.Client, tlsRouteGVR, func() kclient.Informer[*gwv1a2.TLSRoute] {
