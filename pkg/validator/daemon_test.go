...
func TestDaemonValidator_PassThroughSuccess(t *testing.T) {
	inner := &stubValidator{}
	v := NewDaemon(inner, 2)
...
func TestDaemonValidator_PassThroughError(t *testing.T) {
...
func TestDaemonValidator_BoundsConcurrency(t *testing.T) {
	const poolSize = 3
	const callers = 10
...
func TestDaemonValidator_PoolExhaustionUnderConcurrentCallers(t *testing.T) {
...
func TestDaemonValidator_ContextCancellationWhileWaiting(t *testing.T) {
...
func TestDaemonValidator_DefaultPoolSize(t *testing.T) {
