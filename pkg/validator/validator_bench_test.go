...
// stubbed with a fixed-latency fake so the benchmark measures mode overhead
// and cache behavior, not envoy itself. Set KGW_BENCH_REAL_ENVOY=true to run
// the binary-backed variant.
