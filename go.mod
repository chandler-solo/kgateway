...
require (
	...
	github.com/bluesky-social/indigo v0.0.0-20251029062521-aa029b5f2ca7 // indirect
...
// Force older go-progress version for compatibility with quill@v0.5.1 (allowing us to use goreleaser as a 'go tool'
replace github.com/wagoodman/go-progress => github.com/wagoodman/go-progress v0.0.0-20220614130704-4b1c25a33c7c
