...
Use the `TEST_PKG` environment variable to specify which packages to test, and `GO_TEST_USER_ARGS` to pass additional arguments like `-run` regex patterns for test selection.
