...
| `XdsPerClientPublication.CacheReferencedEndpointsPresent` | Referenced EDS cluster is present in CDS but its CLA is missing. | `TestSnapshotPerClientDefersUntilReferencedEDSClustersHaveEndpoints`, `TestSnapshotPerClientDefersUntilReferencedEDSServiceNameHasEndpoints`, `TestSnapshotPerClientDefersMakeBeforeBreakRouteUntilNewEndpointReady`. | Covered | Keep service-name and cluster-name cases together. |
