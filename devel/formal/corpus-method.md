...
[Discovery records](bug-corpus.json) contain sixty-one dispositions: the first eleven discovery mechanisms plus classified batches from go-control-plane, kgateway, Envoy Gateway, Envoy, Gloo, and solo-kit.
